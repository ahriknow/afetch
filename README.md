...
- 🔌 **WebSocket Support** — WebSocket client with plugin system, auto-reconnect, and request-sync (`@ahriknow/afetch/ws`)
...
| [WebSocket](./docs/en/ws.md) | WebSocket client with plugin system, auto-reconnect, and request-sync |
